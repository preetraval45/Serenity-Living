...
export const metadata = {
  ...
  title: {
    default:
      "Serenity Living of Lexington — Premier Senior Living Community in Gilbert, SC",
    template: "%s | Serenity Living of Lexington",
  },
  description:
    "Experience compassionate, dignified care at Serenity Living of Lexington. Our senior living community offers assisted living and skilled nursing services in Gilbert, SC. 24/7 care, rehabilitation, and respite services available.",
  keywords: [
    ...
    "respite care",
    "senior community Lexington",
    "skilled nursing Gilbert SC",
    "Serenity Living",
  ],
  ...
  openGraph: {
    ...
    description:
      "Experience compassionate, dignified care at Serenity Living. Assisted living and skilled nursing in Gilbert, SC.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
  ...
  twitter: {
    ...
    description:
      "Compassionate senior living and skilled nursing in Gilbert, SC.",
    images: ["/og-image.jpg"],
    creator: "@serenitylex",
  },
  robots: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Premier senior living and nursing community providing compassionate assisted living, skilled nursing, and rehabilitation services.",
              url: "https://serenitylivingoflexington.com",
                ...
                itemListElement: [
                  {
                    ...
                    itemOffered: {
                      ...
                      description:
                        "Support for daily activities while preserving independence",
                    },
                  },
                  {
                    "@type": "Offer",
                    itemOffered: {
                      ...
                      description:
                        "24/7 licensed nursing with care coordination and monitoring",
                    },
                  },
                ],
              },
              sameAs: [
                "https://www.facebook.com/share/17kDDcJher/",
